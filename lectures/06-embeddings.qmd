...
## Spatial patterns (T-SNE)

![&nbsp;](images/embedding_space_4.png){width=70%}


## Principal components of the embeddings
...
- **Use embeddings as NLME covariates**
  - Potential dimension reduction first
  - Whatever covariate technique you want

- **Use embeddings as observations**
  - FREM modelling?
  - Fully joint modelling (requires new algorithms to be feasible)

- **Augment existing models**
   - Predict posterior from embeddings
