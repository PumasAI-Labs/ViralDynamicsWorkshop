...
## Deep Nonlinear Mixed Effects {.smaller}
...
**Neural networks can be embedded anywhere in the model!**
:::
...
- No prior knowledge encoded

::: {.fragment}

[**Structured Neural ODE**]{.att}
$$
\begin{aligned}
...
::: {.fragment}
[**Targeted Neural Enhancement**]{.att}
$$
\begin{aligned}
\frac{dDepot}{dt} &= - K_a \cdot Depot\\
\frac{dCentral}{dt} &= K_a \cdot Depot - CL/V_c \cdot Central\\
...
**Random effects allow individual-level neural network behavior!**
...
::: {.incremental}
- **Scientific structure preserved**: PK follows well-understood compartmental model
- **Flexibility where needed**: Neural network captures unknown PD mechanism  
- **Individual-level adaptation**: Random effects allow personalized neural network behavior
- **Data efficiency**: Much less data needed than pure ML approaches
- **Interpretability**: Can understand which parts are mechanism vs data-driven
:::
...
- Build your first DeepNLME model
- See how neural networks integrate with NLME
- Practice with real viral dynamics data
- Understand the power of combining mechanism with ML
:::